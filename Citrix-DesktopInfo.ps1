# ----------------------------------------------------
# Script  :  DesktopInfoDeployment.ps1
# Version :  1.0
# Date    :  8/20/2018
# Author: Jody Ingram
# Pre-reqs: DesktopInfo.exe and desktopinfo.ini 
# This will deploy and run DesktopInfo.exe with a preference table you can modify. This works great in a Citrix or VDI environment.
# ----------------------------------------------------
...
# Check if the folder exists on the local machine, if not, it will create it.
