...
# This script searches all Exchange mailboxes for specific criteria and copies the e-mail out to another user's mailbox.

# USAGE INSTRUCTIONS
#-----------------------------------------------------------------------------------------------------------------------
# Change Subject:"THESE WORDS" to whatever Subject string you want to lookup. Add a comma ";" between subjects to use multiple at once. 
